...
class TestMapServicePublisher(TestCase):
    ...
    def test_delete_service(self):
        ...
        folder_name = 'folder'
        with patch('slap.api.BaseApi.service_exists') as mock_exists:
            mock_exists.return_value = {'exists': True}
            with patch('slap.api.BaseApi.delete_service') as mock_delete:
    ...
    def test_update_service(self):
        ...
        with patch('slap.api.BaseApi.get_service_params') as mock_get_params:
            mock_get_params.return_value = {'baz': 'quux'}
            with patch('slap.api.BaseApi.edit_service') as mock_edit:
